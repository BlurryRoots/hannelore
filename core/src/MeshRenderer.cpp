...
void
MeshRenderer::bind (const Mesh *mesh, ShaderProgram &program) {
...
void
MeshRenderer::render (ShaderProgram &active_program, const Transform *transform) {
...
void
MeshRenderer::unbind (ShaderProgram &program) {
...
void
MeshRenderer::set_primitive (GLenum type) {
...
GLenum
MeshRenderer::get_primitive (void) {
